---
{
  ...
  "url": "https://app.notion.com/p/c-3005a2dd827681849d06f3f4599e8a0a",
  "created_time": "2026-02-07T09:52:00.000Z",
  "last_edited_time": "2026-06-01T10:28:00.000Z"
}
---
...
返回值类型 函数名（函数参数）
{
  ...
  **函数必须有输入必须有输出（非void类型的函数不定义返回值，会返回随机值）**
  ...
  函数传参问题看这个[函数参数的传递的问题](https://app.notion.com/p/2245a2dd827680b6be99fb13c540050f)
分支
  # 分支
  # if语句
  **注意⚠️if语句后不跟分号**
...
char arr[]=＂字符串...＂;
  ```
结构体（自定义数据类型）
  更好的讲解见[结构体（自定义数据类型）](https://app.notion.com/p/20a5a2dd827680acad5ef215c327a1fd) （建议看这个）
...
printf("%d",p);
  ...
  ~~**指针的使用**~~~~看这个~~[给指针赋带取地址符（&）的表达式，就是修改指针存储的地址（相当于写入模式）](https://app.notion.com/p/2245a2dd82768015ab92c5491d573407#2245a2dd8276808c84d2efed69f657b3) 
  [给指针直接赋值，就是修改指针指向元素的值（相当于只读模式）](https://app.notion.com/p/2245a2dd82768015ab92c5491d573407#2245a2dd827680ce883fc6c3393ee93f) 
  **最新版，最精简版：**
  [总结的总结](https://app.notion.com/p/2245a2dd82768015ab92c5491d573407#2785a2dd827680c3bd83f9440595cac7)
二维数组
  ## 声明
  ```c
类型名 数组名 [行大小][列大小];
